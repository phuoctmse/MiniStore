 ...
 * @author ADMIN
 */
@WebServlet(name = "UpdateInRoleAdminController", urlPatterns = {"/UpdateInRoleAdminController"})
public class UpdateInRoleAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(checkValid){
                UserDTO dto = new UserDTO(userId, userName, 2, password);
