<%-- 
    Document   : viewCart
    Created on : Apr 12, 2024, 3:51:32 PM
    Author     : ADMIN
--%>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="home.jsp"><span class="fw-bold text-uppercase text-dark">MiniStore</span></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            ...
                            <ul class="navbar-nav ms-auto">   
                                <li class="nav-item"><a class="nav-link active" href="MainController?action=View"> <i class="fas fa-dolly-flatbed me-1 text-gray"></i>Cart<small class="text-gray fw-normal"></small></a></li>
                                        ...
                                        <tr>
                                            ...
                                            <td class="p-3 align-middle border-light">
                                                <div class="border d-flex align-items-center justify-content-between px-3"><span class="small text-uppercase text-gray headings-font-family">Quantity</span>
                                                    <div class="quantity">
                                                        <input class="form-control form-control-sm border-0 shadow-0 p-0" type="number" min="1" name="quantity" value="<%= product.getQuantity()%>"/>
                                                        <input type="hidden" name="mobileId" value="<%= product.getMobileId()%>">
                                                    </div>
                                                </div>
                                            </td>
                                            <td class="p-3 align-middle border-light">
                                                <p class="mb-0 small"><%= (int) product.getPrice() * product.getQuantity()%></p>
                                            </td>
                                            <td class="p-3 align-middle border-light">
                                                <button type="submit" name="action" value="Edit" class="reset-anchor">
                                                    <i class="fas fa-save small text-muted"></i>
                                                </button>
                                                <a class="reset-anchor" href="MainController?action=Remove&mobileId=<%= product.getMobileId()%>">
