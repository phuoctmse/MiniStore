<%-- 
    Document   : login
    Created on : Apr 20, 2024, 9:08:29 PM
    Author     : ADMIN
--%>
  ...
  <div class="forms">
    <div class="form-wrapper is-active">
      <button type="button" class="switcher switcher-login">
        ...
        <form action="MainController" method="POST" class="form form-login">
        <fieldset>
          <legend>Please, enter your email and password for login.</legend>
          <div class="input-block">
            <label for="login-email">User ID</label>
            <input id="login-email" type="text" name="userId" required>
          </div>
          <div class="input-block">
    ...
    <div class="form-wrapper">
      <button type="button" class="switcher switcher-signup">
        ...
        <form action="MainController" method="POST" class="form form-signup">
        <fieldset>
          <legend>Please, enter your email, password and password confirmation for sign up.</legend>
          <div class="input-block">
            <label for="signup-username">User ID</label>
            <input id="signup-email" type="text" name="userId" required>
          </div>
          <div class="input-block">
          ...
          <div class="input-block">
            ...
            <input id="signup-password" type="password" name="confirm" required>
          </div>
        </fieldset>
