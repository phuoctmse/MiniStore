<%-- 
    Document   : home_logged
    Created on : Apr 24, 2024, 1:11:44 AM
    Author     : ADMIN
--%>
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light py-3 px-lg-0"><a class="navbar-brand" href="home_logged.jsp"><span class="fw-bold text-uppercase text-dark">MiniStore</span></a>
                        ...
                        <div class="collapse navbar-collapse" id="navbarSupportedContent">
                            <ul class="navbar-nav me-auto">
                                <li class="nav-item">
                                    <!-- Link--><a class="nav-link active" href="home_logged.jsp">Home</a>
                                </li>
                                <li class="nav-item">
                                    ...
                                    <div class="product-overlay">
                                        <ul class="mb-0 list-inline">
                                            ...
                                            <li class="list-inline-item m-0 p-0"><a class="btn btn-sm btn-dark" href="AddToCartController?mobileId=<%= product.getMobileId()%>
                                                                                    ...
                                                                                    &category=<%= product.getCategory()%>">Add to cart</a></li>
                                        </ul>
                                    </div>
                                </div>
